...
def main():
    ...
    ckpt = f"/gws/nopw/j04/wiser_ewsa/mrakotomanga/OB/checkpoints/lstm_core2map_hybrid/t{lead}/seed{seed}"
    ...
    trainer = pl.Trainer(
        ...
        logger=WandbLogger(project="western_sahel_lstm_core2map_auc_and_fss",
